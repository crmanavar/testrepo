                ...
                <table class="table card-table table-striped table-vcenter">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="w-1"><a href="#" class="icon"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        <tr>
                            ...
                            <td><a href="#" class="icon"><i class="fa fa-trash"></i></a></td>
                        </tr>
                        <tr>
        ...
        <div class="card p-3">
            <div class="d-flex align-items-center">
                <span class="stamp stamp-md bg-yellow mr-3">
                    <i class="fa fa-message-square"></i>
                </span>
                <div>
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="d-flex align-items-center pt-5 mt-auto">
                    ...
                    <div class="ml-auto text-muted">
                        <a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fa fa-heart mr-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <td class="text-center">
                                <div class="item-action dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fa fa-tag"></i> Action </a>
                                        <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fa fa-edit-2"></i> Another action </a>
                                        <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fa fa-message-square"></i> Something else here</a>
                                        <div class="dropdown-divider"></div>
                                        <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fa fa-link"></i> Separated link</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
